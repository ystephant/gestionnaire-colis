              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-4 w-full">
                  <div className="flex-1 min-w-0">
                    ...
                    {/* [transit] Case à cocher : achat reçu directement (braderie, main propre) */}
                    <label className={`mt-2 flex items-center gap-2 text-xs font-medium cursor-pointer select-none ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                      <input
                        type="checkbox"
                        checked={buyReceivedDirectly}
                        onChange={(e) => setBuyReceivedDirectly(e.target.checked)}
                        className="w-4 h-4 rounded accent-red-500"
                      />
                      🏠 Reçu directement (braderie, pas de transit)
                    </label>
                  </div>
